...
public class InitialDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void createInitialOngs() {
        ...
        evento3.setDescricao("Venha nos auxiliar no ensino de música para as comunidades do morro.");
        ...
        evento4.setDescricao("Idealização, confecção e distribuição da cartilha: o que é apropriação cultural?");
        ...
        evento5.setDescricao("Exame gratuito para detecção de melanoma.");
        evento5.setAreas(Arrays.asList("Saúde"));
        evento5.setDataRealizacao(LocalDateTime.of(2019, 12, 12, 14, 30));
        Evento evento6 = new Evento();
        evento6.setNome("Alerta laranja");
        evento6.setDescricao("Workshop de disseminação dos efeitos do desmatamento do cerrado.");
